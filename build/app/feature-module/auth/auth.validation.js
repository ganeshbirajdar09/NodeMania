...
exports.REFRESH_TOKEN_VALIDATIONS = exports.LOGIN_VALIDATOR = exports.REGISTRATION_VALIDATOR = exports.ADMIN_REGISTRATION_VALIDATOR = void 0;
...
exports.REGISTRATION_VALIDATOR = [
    (0, express_validator_1.body)("username").exists().withMessage("name is required").isString().withMessage("name must be a string value"),
    (0, express_validator_1.body)("email").exists().withMessage("email is required").isEmail().withMessage("email should in a valid email format"),
    (0, express_validator_1.body)("password").exists().withMessage("password is required").isLength({ min: 3 }).withMessage("password is required"),
    validate_1.validate
];
