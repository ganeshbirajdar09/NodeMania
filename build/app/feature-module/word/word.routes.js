...
router.get("/", (0, authorize_1.permit)([constants_1.ROLES.ADMIN, constants_1.ROLES.USER]), global_validations_1.PAGINATION_VALIDATIONS, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield word_service_1.default.getAll(queryData);
...
router.post("/", (0, authorize_1.permit)([constants_1.ROLES.ADMIN]), word_validations_1.ADD_WORD_VALIDATIONS, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const word = req.body;
        const result = yield word_service_1.default.create(word);
        res.send(new response_handler_1.ResponseHandler(result));
    }
    catch (error) {
        next(error);
...
router.patch("/", (0, authorize_1.permit)([constants_1.ROLES.ADMIN]), word_validations_1.UPDATE_WORD_VALIDATIONS, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const _a = req.body, { _id } = _a, wordData = __rest(_a, ["_id"]);
        const result = yield word_service_1.default.update(_id, wordData);
        res.send(new response_handler_1.ResponseHandler(result));
    }
    catch (error) {
        next(error);
...
router.delete("/:id", (0, authorize_1.permit)([constants_1.ROLES.ADMIN]), global_validations_1.PARAM_ID_VALIDATIONS, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield word_service_1.default.remove(req.params.id);
        res.send(new response_handler_1.ResponseHandler(result));
    }
    catch (error) {
        next(error);
...
router.get("/:id", (0, authorize_1.permit)([constants_1.ROLES.ADMIN, constants_1.ROLES.USER]), global_validations_1.PARAM_ID_VALIDATIONS, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield word_service_1.default.findById(req.params.id);
        res.send(new response_handler_1.ResponseHandler(result));
    }
    catch (error) {
        next(error);
